...
public class LoggingProperties {
	...
	public LoggingProperties() {
		...
		this.handlers = HANDLERS + properties.stream().map(property->property.getHandler()).collect(Collectors.joining(","));
	}
	...
	public void addProperty(LoggingProperty property) {
		...
		this.handlers = HANDLERS + properties.stream().map(prop->prop.getHandler()).collect(Collectors.joining(","));
	}
