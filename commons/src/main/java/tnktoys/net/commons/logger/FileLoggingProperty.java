...
import tnktoys.net.commons.util.DateTimeUtil;
...
//		LoggingProperty property = new FileLoggingProperty();
//		System.out.println(property.getLoggingProperty());
		System.out.println("result="+DateTimeUtil.getDateString(true));
		System.out.println("result="+DateTimeUtil.getDateTimeString(true));
		System.out.println("result="+DateTimeUtil.getDateTimeInMillsString(true));
	}
